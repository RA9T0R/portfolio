...
// --- GitHubIcon Component (Already Correct) ---
export const GitHubIcon = ({ className = 'text-Text', width = 24, height = 24 }) => {
    return (
        <svg
            width={width}
            height={height}
...
export const GmailIcon = ({ className = 'text-Text', width = 24, height = 24 }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            aria-label="Gmail"
...
export const DiscordIcon = ({ className = 'text-Text', width = 24, height = 24 }) => {
    return (
        <svg
            width={width}
            height={height}
            viewBox="0 0 24 24"
            fill="currentColor" // The SVG inherits the color from the parent component's class
            xmlns="http://www.w3.org/2000/svg"
            className={className}
        >
            <path
...
export const FacebookIcon = ({className = 'text-Text', width = 24, height = 24 }) => {
    return (
